 ...
 */
int cnstr_black_key_jobdesc(u32 **desc, dma_addr_t key, size_t key_length,
			    dma_addr_t cover_key, size_t cover_key_length,
...
int cnstr_blob_encap_jobdesc(u32 **desc,
			     dma_addr_t secret, size_t secret_length,
			     u8 keycolor, u8 auth, u8 trusted_key,
			     u8 memtype,
			     dma_addr_t keymod, size_t keymod_length,
...
int cnstr_key_jobdesc(u32 **desc,
		      dma_addr_t key, size_t key_size, size_t key_length,
