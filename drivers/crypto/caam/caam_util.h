...
extern void caam_key_blob_done(struct device *dev, u32 *desc, u32 err,
			       void *context);
...
extern void unprepare_read_data(struct device *jrdev, dma_addr_t dma_addr,
				u8 *allocated_data, size_t size);

extern dma_addr_t get_caam_dma_addr(const void *address);
...
extern int caam_blobencap(struct device *jrdev,
...
extern int caam_blobdecap(struct device *jrdev,
